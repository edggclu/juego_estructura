...
class ventana_cargar_partida:
    def __init__(self, ventana):
        ...
        self.boton1 = boton_cargar_partida(self.ventana, pos_x, pos_y1, "assets/Sprites/skeleton_Base/Idle/skeleton_Base_Idle0.png" ,5, 5,"Luis miguel - Partida 1")
        self.boton2 = boton_cargar_partida(self.ventana, pos_x, pos_y2, "assets/Sprites/skeleton_Base/Idle/skeleton_Base_Idle0.png", 5, 5,"Andresaurio espinoza - Partida 2")
        self.boton3 = boton_cargar_partida(self.ventana, pos_x, pos_y3, "assets/Sprites/skeleton_Base/Idle/skeleton_Base_Idle0.png", 5, 5,"Puñaron - Partida 3")
        self.boton4 = boton_cargar_partida(self.ventana, pos_x, pos_y4,"assets/Sprites/skeleton_Base/Idle/skeleton_Base_Idle0.png", 5, 5, "José José - Partida 4")
